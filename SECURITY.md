...
- **Model accuracy**: Trained on LLM-labeled real OpenClaw skills (3-class). Calibrated with ECE=0.044 on real data. Entropy-based abstention flags uncertain predictions for human review.
